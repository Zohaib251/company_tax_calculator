...
class TaxEngine {
  ...
  calculateAll() {
    ...
    // D56 = SUM(D57:D65)
    this.data["D56"] = this.sumRange("D", 57, 65);
    // E56 = SUM(E57:E65)
    ...
    // D66 = +D26-D28+D56
    this.data["D66"] =
      this.getValue("D26") - this.getValue("D28") + this.getValue("D56");
    // E66 = +E26-E28+E56
    this.data["E66"] =
    ...
    // C108 = +C66+C68-C101
    this.data["C108"] =
      this.getValue("C66") + this.getValue("C68") - this.getValue("C101");
    // D108 = D66 + D68 - D101
    this.data["D108"] =
      this.getValue("D66") + this.getValue("D68") - this.getValue("D101");
    // E108 = +E66+E68-E101
    this.data["E108"] =
      this.getValue("E66") + this.getValue("E68") - this.getValue("E101");
    ...
    this.data["E132"] =
      taxableRevenue > 100000000 ? taxableRevenue * 0.0125 : 0;
    ...
    this.data["E141"] = startupRegistered
      ? this.getValue("E128")
      : this.getValue("C141");
