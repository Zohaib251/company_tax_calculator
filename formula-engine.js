...
class TaxEngine {
    ...
    calculateAll() {
        ...
        this.data['E137'] = this.getValue('E135') * 0.29;
    ...
    getTaxResults() {
        return {
            ...
            taxChargeable: this.getValue('E134'),    // E134 = tax chargeable formula result
            admittedTax: this.getValue('E156'),      // E156 = admitted tax calculation
            refundableTax: 0, // Not calculated as per "(Don't use this including formula)"
